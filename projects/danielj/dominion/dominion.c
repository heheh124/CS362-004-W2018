...
//2
	int adventurerEffect (int currentPlayer, int drawntreasure, int cardDrawn, int *temphand, int z, struct gameState *state) 
	{
		//bug #2
...
//4
	int feastEffect (int currentPlayer, int *temphand, int choice1, struct gameState *state) 
	{
	int i, x = 0;
...
//5 
	int baronEffect (int currentPlayer, int choice1, struct gameState *state) {			
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	//refactor baron	
    case baron:
		return baronEffect(currentPlayer, choice1, state);
